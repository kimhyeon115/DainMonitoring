package com.dain23.cheomseongdae.controller;
 ...
 **/
@RestController
@RequestMapping("cheomseongdae/api")
public class CheomseongdaeAPIController {
	
	/* 현장 코드 */
	private final String placeCode = "cheomseongdae";
