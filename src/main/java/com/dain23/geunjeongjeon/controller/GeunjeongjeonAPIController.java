package com.dain23.geunjeongjeon.controller;
 ...
 **/
@RestController
@RequestMapping("/geunjeongjeon/api")
public class GeunjeongjeonAPIController {
	
	/* 현장 코드 */
	private final String placeCode = "geunjeongjeon";
